function CheckValid() {
    ...
    return "" == e || "search" == e ? ($('.search input[type="text"]').addClass("searchError"),
    !1) : !0
}
$(document).ready(function() {
    ...
    e.prototype = {
        initEvents: function() {
            ...
            e.opts.on("click", function() {
                ...
                e.sort = t.attr("data-sort"),
                $(".filtered-products-container").mixItUp("sort", e.sort)
            })
        },
        getValue: function() {
            return this.val
    ...
    $(window).bind("scroll", function() {
        var e = 64;
        $(window).scrollTop() > e && $(window).width() > 1024 ? ($(".main-header").addClass("fixed"),
        $("body").css("padding-top", "64px")) : ($(".main-header").removeClass("fixed"),
        $("body").css("padding-top", "0px"))
    }),
    $(window).hashchange(function() {
        if ("" == location.hash)
            var e = $(".hash").find("a.accordion-toggle").slice(0, 1).attr("href");
        else
            var e = location.hash;
        $(".hash .accordion-toggle").each(function() {
            return $(this).attr("href") === e ? ($(this).trigger("click"),
            PriceSpider.rebind(),
            !1) : void 0
        })
    }),
    ...
    t.indexOf("/flashlights-lighting") >= 0 || t.indexOf("/everyday-flashlights") >= 0 ? $(".filtered-products-container").mixItUp("sort", "myorder:asc") : t.indexOf("/hands-free-lighting") >= 0 ? $(".filtered-products-container").mixItUp("sort", "handsfreeorder:asc defaultorder:asc") : t.indexOf("/emergency-lighting") >= 0 ? $(".filtered-products-container").mixItUp("sort", "preorder:asc") : t.indexOf("/outdoor-lighting") >= 0 ? $(".filtered-products-container").mixItUp("sort", "outorder:asc") : t.indexOf("/do-it-yourself") >= 0 && $(".filtered-products-container").mixItUp("sort", "diyorder:asc"),
    t.indexOf("/energizer-ultimate-lithium-batteries") >= 0 && ($("body").removeClass("background-red"),
    $("body").addClass("background-blue"),
    $('div[class="hash accordion-container"]').addClass("lithium-accordion")),
    (t.indexOf("/battery-chargers") >= 0 || t.indexOf("/energizer-rechargeable-batteries") >= 0) && ($("body").removeClass("background-red"),
    $("body").addClass("background-green")),
    (t.indexOf("/eco-advanced-batteries") >= 0 || t.indexOf("/ecoadvanced") >= 0 || t.indexOf("/eco-advanced-battery-coupon") >= 0) && ($("body").removeClass("background-red"),
    $("body").addClass("background-eco")),
    t.indexOf("/buybatteries") >= 0 && $(".main-container").addClass("contact-container -buy-now"),
    t.indexOf("/energizer-advanced-lithium-batteries") >= 0 && ($("body").removeClass("background-red"),
    $("body").addClass("background-yellow")),
    t.indexOf("/hearing-aid-batteries") >= 0 && $(".page-meta").addClass("hearing-aids-meta"),
    ...
    $('span[class="sshIcon sshShareOnFacebook fa icon-header fa-facebook btf"]').removeClass("sshIcon sshShareOnFacebook "),
    $('a[ title="Tweet this" ]').removeClass("sshListItem").addClass("twitter"),
    $('span[class="sshIcon sshShareOnTwitter fa icon-header fa-twitter btt"]').removeClass("sshIcon sshShareOnTwitter "),
    ...
    $('span[class="sshIcon sshGoogleBookmarks fa icon-header fa-google-plus btg"]').removeClass("sshIcon sshGoogleBookmarks "),
...
$(document).ready(function() {
    ...
    if (e.indexOf("/hearing-aid-batteries") >= 0 && ($(".product-family-image").before('<p class="font-size"> <span> <a href="#!" id="decreaseFontSize">Smaller</a> </span> <span>Type Size</span> <span> <a href="#!" id="increaseFontSize">Larger</a> </span> </p>'),
    $('p:contains("Type Size")').css("margin-top", "0%"),
    -1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") && $('p:contains("Type Size")').css("margin-bottom", "3%")),
    ...
    -1 == window.location.href.search("[?&]")) {
        var t = $("#subnav-echoadvanced").attr("href");
        $("#subnav-echoadvanced").attr("href", t + "?utm_source=dropdownpromobannerk&amp;utm_medium=website&amp;utm_campaign=ecoadvanced"),
        t = $(".promo-echoadvanced").attr("href"),
        $(".promo-echoadvanced").attr("href", t + "?utm_source=promotionpagepromobanner&amp;utm_medium=website&amp;utm_campaign=ecoadvanced")
    } else {
        var t = $("#subnav-echoadvanced").attr("href");
        $("#subnav-echoadvanced").attr("href"),
        t = $(".promo-echoadvanced").attr("href"),
        $(".promo-echoadvanced").attr("href")
    }
    var a = [];
    ...
    $(".footer-menu-container a").each(function(e) {
        var t = $(this).attr("href");
        t = t.substr(t.lastIndexOf("/") + 1),
        $(this).addClass("bottomnav-" + t)
    }),
    $(".font-size a").on("click", function() {
        if ($(".main-container[data-font-size]").length)
            var e = $(".main-container").attr("data-font-size");
        else
            var e = $(".main-container").css("font-size");
        e = parseInt(e),
        "decreaseFontSize" == $(this).attr("id") ? e -= 2 : e += 2,
        e += "px",
        $("#font-change").length ? ($("#font-change").empty(),
        $("#font-change").append(".main-container p, .accordion-container ul, pagehead-social ul:not(:first-child), .accordion-toggle, .family-info .family-meta span{font-size:" + e + ";}")) : $("body").append("<style id='font-change'>.main-container p, .accordion-container ul, pagehead-social ul:not(:first-child), .accordion-toggle, .family-info .family-meta span{font-size:" + e + ";}</style>"),
        $(".main-container").attr("data-font-size", e)
    }),
    $("#Container").mixItUp(),
